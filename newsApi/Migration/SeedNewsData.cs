    ...
    public static async Task SeedAsync(MongoDbContext context)
    {
        ...
        var newsList = new List<News>
        {
            ...
            new News
            {
                ...
                Content = "OpenAI, yapay zeka alanındaki en son hamlesiyle GPT-5 modelini tanıttı. Yeni model, önceki versiyonlara göre %300 daha hızlı ve daha doğru sonuçlar üretiyor. Dil işleme, görüntü analizi ve çok modlu öğrenme yetenekleri ile GPT-5, endüstri standardını yeniden belirliyor. Araştırmacılar, modelin etik kullanım için gelişmiş güvenlik önlemleriyle donatıldığını vurguluyor.",
            ...
            new News
            {
                ...
                Summary = "2024 yılında dünya genelinde 14 milyon elektrikli araç satıldı. Tesla ve BYD pazarda lider konumda.",
                ImgPath = "https://ichef.bbci.co.uk/news/976/cpsprodpb/1237/production/_123456792_ev.jpg",
                ImgAlt = "Elektrikli Araç Şarj İstasyonu",
                Content = "Elektrikli araç pazarı 2024'te rekor kırdı. Dünya genelinde 14 milyon EV satışı gerçekleşti, bu bir önceki yıla göre %35 artışı temsil ediyor. Tesla Model Y en çok satan model olurken, Çinli BYD üretim hacmi ile liderliği ele geçirdi. Batarya teknolojisindeki ilerlemeler, menzil kaygısını ortadan kaldırıyor ve şarj süreleri 15 dakikaya kadar indi.",
            ...
            new News
            {
                ...
                Content = "AB liderleri, uzun süren müzakerelerden sonra ortak göç politikası konusunda anlaşmaya vardı. Yeni sistem, sınır kontrollerini güçlendirirken, üye ülkeler arasında dayanışma mekanizması kuruyor. Mülteci başvurularının daha hızlı işlenmesi ve entegrasyon programlarının iyileştirilmesi öngörülüyor.",
            ...
            new News
            {
                ...
                Summary = "SpaceX'in Starship aracı, ilk ticari uzay turizmini başlattı. 4 turistik yolcu, Ay'ın çevresinde 6 günlük yolculuğa çıktı.",
                ImgPath = "https://ichef.bbci.co.uk/news/976/cpsprodpb/1241/production/_123456796_space.jpg",
                ImgAlt = "Starship Uzay Aracı",
                Content = "SpaceX'in Starship uzay aracı, tarihi ilk ticari ay turunu başarıyla tamamladı. 4 sivil yolcu, 6 gün boyunca Ay'ın etrafında dönme imkanı buldu. Bilet fiyatları 200 milyon dolar civarında. Blue Origin ve Virgin Galactic de sub-orbital uçuşlarını yoğunlaştırıyor. Uzay turizmi endüstrisi 2030'da 3 milyar dolara ulaşacak.",
            ...
            new News
            {
                ...
                Summary = "Türkiye ekonomisi 2025 ilk çeyreğinde %5.2 büyüme kaydetti. İmalat sanayi ve ihracat büyümenin lokomotifi oldu.",
                ...
                Content = "TÜİK verilerine göre, Türkiye ekonomisi 2025'in ilk çeyreğinde %5.2 büyüme kaydetti. İmalat sanayi %7.1, hizmetler sektörü %4.8 büyüdü. İhracat rekor seviyede arttı ve 70 milyar dolara ulaştı. Enflasyonla mücadele devam ederken, yatırımcı güveni artıyor. Ekonomistler yıl sonu büyüme tahminlerini %4.5'e yükseltti.",
            ...
            new News
            {
                ...
                Summary = "Bitcoin 75,000 dolar seviyesini aştı. Ethereum ve diğer altcoinler de güçlü yükseliş gösteriyor.",
                ImgPath = "https://ichef.bbci.co.uk/news/976/cpsprodpb/1243/production/_123456798_crypto.jpg",
                ImgAlt = "Bitcoin Grafiği",
                Content = "Kripto para piyasalarında güçlü yükseliş devam ediyor. Bitcoin, tarihinde ilk kez 75,000 doları aştı. Ethereum 4,500 dolar seviyesinde işlem görüyor. Kurumsal yatırımcıların artan ilgisi ve Bitcoin ETF'lerinin başarısı, rallinin arkasındaki temel faktörler. Analistler yıl sonuna kadar Bitcoin'in 100,000 dolara ulaşabileceğini öngörüyor.",
            ...
            new News
            {
                ...
                Summary = "2024 yılında Türk startupları toplam 2 milyar dolar yatırım aldı. E-ticaret ve fintech sektörleri öne çıktı.",
                ImgPath = "https://ichef.bbci.co.uk/news/976/cpsprodpb/1244/production/_123456799_startup.jpg",
                ImgAlt = "Startup Ofisi",
                Content = "Türkiye'nin girişim ekosistemi 2024'te rekor yatırım aldı. E-ticaret platformu Trendyol'un değerlemesi 20 milyar dolara ulaştı. Fintech girişimi Papara unicorn statüsü kazandı. Oyun, yapay zeka ve yeşil teknoloji alanlarındaki startuplar da önemli yatırımlar çekti. Türkiye, Avrupa'nın en hızlı büyüyen startup ekosistemlerinden biri haline geldi.",
            ...
            new News
            {
                ...
                Summary = "NASA'nın Perseverance rover'ı, Mars'ın yüzeyinin altında sıvı su izleri ve olası mikrobiyal yaşam belirtileri tespit etti.",
                ImgPath = "https://ichef.bbci.co.uk/news/976/cpsprodpb/1245/production/_123456800_mars.jpg",
                ImgAlt = "Mars Yüzeyi",
                Content = "NASA'nın Perseverance uzay aracı, Mars'ta devrim niteliğinde bir keşif yaptı. Jezero Krateri'nin altında sıvı su rezervleri tespit edildi. Daha da önemlisi, su örneklerinde organik moleküller ve olası mikrobiyal yaşam izleri bulundu. Bu keşif, Mars'ta yaşam olduğuna dair en güçlü kanıtları sunuyor. Bilim insanları, bu bulguların Mars misyonlarının yönünü değiştireceğini söylüyor.",
            ...
            new News
            {
                ...
                Summary = "mRNA teknolojisi kullanılarak geliştirilen kişiselleştirilmiş kanser aşıları, klinik deneylerde %90 başarı oranı gösterdi.",
                ...
                Content = "BioNTech ve Moderna'nın ortaklaşa geliştirdiği mRNA bazlı kanser aşısı, Faz 3 denemelerinde çığır açan sonuçlar verdi. Hastanın kendi tümör hücrelerinden üretilen kişiselleştirilmiş aşı, %90 başarı oranı gösterdi. Melanom, akciğer ve pankreas kanseri hastalarında tümör küçülmesi gözlendi. FDA onayının 2026'da beklenmesi, milyonlarca hasta için umut ışığı.",
            ...
            new News
            {
                ...
                Summary = "Stanford Üniversitesi araştırması, AI sistemlerinin radyoloji görüntülerinden hastalık tespitinde %95 doğrulukla insan doktorları geçtiğini gösterdi.",
                ...
                Content = "Stanford Tıp Fakültesi'nden araştırmacılar, derin öğrenme algoritmaları kullanarak geliştirdikleri AI sisteminin, röntgen, MR ve CT görüntülerinden hastalık tespitinde %95 doğruluk oranına ulaştığını açıkladı. Sistem, akciğer kanseri, pnömoni ve kemik kırıklarını erken evrede tespit edebiliyor. Radyologların iş yükünü azaltırken, tanı sürecini hızlandırıyor.",
            ...
            new News
            {
                ...
                Summary = "Trabzonspor'un genç yetenekleri, altyapı sisteminde göz dolduran performanslar sergiliyor. A takıma yükselme hazırlığındalar.",
            ...
            new News
            {
                ...
                Summary = "Türkiye Futbol Federasyonu, Süper Lig formatında önemli değişikliklere gidiyor. 2026-2027 sezonundan itibaren yeni sistem uygulanacak.",
                ImgPath = "https://ichef.bbci.co.uk/news/976/cpsprodpb/1254/production/_123456809_tff.jpg",
                ImgAlt = "TFF Logosu",
                Content = "Türkiye Futbol Federasyonu Yönetim Kurulu, Süper Lig formatında radikal değişikliklere gidilmesine karar verdi. 2026-2027 sezonundan itibaren lig 20 takıma çıkarılacak. Playoff sisteminin getirilmesi, yabancı futbolcu kuralının revizyonu ve VAR sisteminin geliştirilmesi planlanıyor. Kulüpler ve futbol kamuoyu, değişiklikler hakkında görüşlerini bildiriyor.",
            ...
            new News
            {
                ...
                Summary = "Galatasaray, Şampiyonlar Ligi'nde çeyrek finale yükselen ilk Türk takımı oldu. Manchester City'yi eleyerek tarihi başarıya imza attı.",
