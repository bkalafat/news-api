...
Write-Host "  Update image: az containerapp update --name ${projectName}-backend --resource-group $resourceGroup --image ${acrLoginServer}/newsapi:latest" -ForegroundColor White
