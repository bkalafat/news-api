...
describe("Footer Component", () => {
  ...
  it("includes links to important pages", () => {
    ...
    // Common footer links
    const importantLinks = [/hakkımızda|about/i, /iletişim|contact/i, /gizlilik|privacy/i];
  ...
  it("applies background styling", () => {
    ...
    const hasBackground = footer?.className.includes("bg-") || footer?.className.includes("border");
  ...
  it("renders accessibility-friendly content", () => {
    ...
    links.forEach((link) => {
      ...
      const hasTextOrLabel =
        link.textContent || link.getAttribute("aria-label") || link.querySelector("svg");
